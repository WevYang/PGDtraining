...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        adv = adversary.perturb(inputs, targets_a)
        adv_outputs = net(adv)
        loss = mixup_criterion(criterion, adv_outputs, targets_a, targets_b, lam)
        loss.backward()
        ...
        if batch_idx % 10 == 0:
            ...
            print('Current adversarial train accuracy:', str(predicted.eq(targets_a).sum().item() / targets_a.size(0)))
